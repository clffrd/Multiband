    ...
    : AudioProcessorEditor (&p), processor (p)
{
    ...
    (*sliderLowThreshold).setSliderStyle (Slider::Rotary);
    ...
    (*sliderMidThreshold).setSliderStyle (Slider::Rotary);
    ...
    (*sliderHighThreshold).setSliderStyle (Slider::Rotary);
    (*sliderHighThreshold).setTextBoxStyle (Slider::TextBoxAbove, false, 100, 20);
    ...
    (*sliderHighRatio).setTextBoxStyle (Slider::TextBoxBelow, true, 100, 20);
    ...
    (*sliderHighAttack).setTextBoxStyle (Slider::TextBoxBelow, true, 100, 20);
    ...
    (*sliderHighRelease).setTextBoxStyle (Slider::TextBoxBelow, true, 100, 20);
    ...
    (*sliderHighGain).setTextBoxStyle (Slider::TextBoxBelow, false, 100, 20);
    ...
    (*sliderLowCutoff).setTextBoxStyle (Slider::TextBoxBelow, false, 100, 20);
    ...
    (*sliderHighCutoff).setTextBoxStyle (Slider::TextBoxBelow, false, 100, 20);
    ...
    (*buttonLowCompressorState).setColour(TextButton::buttonOnColourId, Colours::lightyellow);
    ...
    (*buttonMidCompressorState).setColour(TextButton::buttonOnColourId, Colours::lightyellow);
    ...
    (*buttonHighCompressorState).setColour(TextButton::buttonOnColourId, Colours::lightyellow);
...
void MultibandCompressorAudioProcessorEditor::resized()
{
    ...
    (*sliderLowCutoff).setBounds (110, 31, 60, 60);
    (*sliderHighCutoff).setBounds (410, 31, 60, 60);
    
    // Compressor State Buttons
    (*buttonLowCompressorState).setBounds (130, 130, 50, 24);
    (*buttonMidCompressorState).setBounds (280, 130, 50, 24);
    (*buttonHighCompressorState).setBounds (430, 130, 50, 24);
    
    // Threshold Knobs
    (*sliderLowThreshold).setBounds (115, 110, 80, 150);
    (*sliderMidThreshold).setBounds (265, 110, 80, 150);
    (*sliderHighThreshold).setBounds (415, 110, 80, 150);
